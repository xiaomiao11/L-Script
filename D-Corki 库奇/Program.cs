...
namespace D_Corki
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //D Corki
            _config = new Menu("D-Corki浜岀嫍姹夊寲", "D-Corki", true);
            ...
            _config.SubMenu("Combo")
                .AddItem(new MenuItem("UseWHE", "浣跨敤W琛€閲弢>").SetValue(new Slider(65, 1, 100)));
            _config.SubMenu("Combo").AddItem(new MenuItem("EnemyC", "浣跨敤R浜烘暟<").SetValue(new Slider(2, 1, 5)));
            ...
            _config.SubMenu("Harass").AddItem(new MenuItem("UseRH", "浣跨敤 R")).SetValue(true);
            _config.SubMenu("Harass").AddItem(new MenuItem("RlimH", "浣跨敤R鏁伴噺>").SetValue(new Slider(3, 1, 7)));
            _config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("harasstoggle", "楠氭壈锛堣嚜鍔級").SetValue(new KeyBind("G".ToCharArray()[0],
                        KeyBindType.Toggle)));
            _config.SubMenu("Harass")
                .AddItem(new MenuItem("Harrasmana", "楠氭壈钃濋噺").SetValue(new Slider(60, 1, 100)));
            _config.SubMenu("Harass")
                .AddItem(
            ...
            _config.SubMenu("Farm").AddItem(new MenuItem("UseEL", "E 娓呭叺")).SetValue(true);
            _config.SubMenu("Farm").AddItem(new MenuItem("UseRL", "R 娓呭叺")).SetValue(true);
            _config.SubMenu("Farm").AddItem(new MenuItem("UseQLH", "Q 琛ュ垁")).SetValue(true);
            _config.SubMenu("Farm").AddItem(new MenuItem("UseELH", "E 琛ュ垁")).SetValue(true);
            ...
            _config.SubMenu("Farm").AddItem(new MenuItem("RlimL", "R 娓呴噹 >").SetValue(new Slider(3, 1, 7)));
            ...
            _config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("ActiveLane", "娓呭叺|閲巪!").SetValue(new KeyBind("V".ToCharArray()[0],
                        KeyBindType.Press)));

            //Misc
            _config.AddSubMenu(new Menu("鏉傞」", "Misc"));
            _config.SubMenu("Misc").AddItem(new MenuItem("UseQM", "Q 鎶汉澶磡")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("UseEM", "E 鎶汉澶磡")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("UseRM", "R 鎶汉澶磡")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("skinC", "浣跨敤鎹㈣偆").SetValue(false));
            _config.SubMenu("Misc").AddItem(new MenuItem("skinCorki", "鐨偆閫夋嫨").SetValue(new Slider(4, 1, 7)));
            ...
            _config.SubMenu("HitChance").SubMenu("Harass").AddItem(new MenuItem("QchangeHar", "Q鍛戒腑鐜噟").SetValue(
                new StringList(new[] { "浣巪", "涓瓅", "楂榺", "寰堥珮|" })));
            _config.SubMenu("HitChance").SubMenu("Harass").AddItem(new MenuItem("EchangeHar", "E鍛戒腑鐜噟").SetValue(
                new StringList(new[] { "浣巪", "涓瓅", "楂榺", "寰堥珮|" })));
            _config.SubMenu("HitChance").SubMenu("Harass").AddItem(new MenuItem("RchangeHar", "R鍛戒腑鐜噟").SetValue(
                new StringList(new[] { "浣巪", "涓瓅", "楂榺", "寰堥珮|" })));
            _config.SubMenu("HitChance").AddSubMenu(new Menu("杩炴嫑", "Combo"));
            _config.SubMenu("HitChance").SubMenu("Combo").AddItem(new MenuItem("Qchange", "Q鍛戒腑鐜噟").SetValue(
                new StringList(new[] { "浣巪", "涓瓅", "楂榺", "寰堥珮|" })));
            _config.SubMenu("HitChance").SubMenu("Combo").AddItem(new MenuItem("Echange", "E鍛戒腑鐜噟").SetValue(
                new StringList(new[] { "浣巪", "涓瓅", "楂榺", "寰堥珮|" })));
            _config.SubMenu("HitChance").SubMenu("Combo").AddItem(new MenuItem("Rchange", "R鍛戒腑鐜噟").SetValue(
                new StringList(new[] { "浣巪", "涓瓅", "楂榺", "寰堥珮|" })));
            _config.SubMenu("HitChance").AddSubMenu(new Menu("鎶汉澶磡", "KillSteal"));
            _config.SubMenu("HitChance").SubMenu("KillSteal").AddItem(new MenuItem("Qchangekil", "Q鍛戒腑鐜噟").SetValue(
                new StringList(new[] { "浣巪", "涓瓅", "楂榺", "寰堥珮|" })));
            _config.SubMenu("HitChance").SubMenu("KillSteal").AddItem(new MenuItem("Echangekil", "E鍛戒腑鐜噟").SetValue(
                new StringList(new[] { "浣巪", "涓瓅", "楂榺", "寰堥珮|" })));
            _config.SubMenu("HitChance").SubMenu("KillSteal").AddItem(new MenuItem("Rchangekil", "R鍛戒腑鐜噟").SetValue(
                new StringList(new[] { "浣巪", "涓瓅", "楂榺", "寰堥珮|" })));
            ...
            Game.PrintChat("<font color='#881df2'>D-Corki by Diabaths</font> 鍔犺浇鎴愬姛!姹夊寲by浜岀嫍!QQ缇361630847.");
