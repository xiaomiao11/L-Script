...
namespace DZDraven_Reloaded
{
    class Cleanser
    {
        ...
        public static void CreateTypeQSSMenu()
        {
            ...
            DZDraven_Reloaded.Menu.SubMenu("QSST").AddItem(new MenuItem("supression", "鎶戝埗").SetValue(true));
            ...
            DZDraven_Reloaded.Menu.SubMenu("QSST").AddItem(new MenuItem("poison", "鍒跺害").SetValue(false));
        }
