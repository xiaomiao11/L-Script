...
namespace Evade
{
    internal class EvadeSpellDatabase
    {
        ...
        static EvadeSpellDatabase()
        {
            ...
            //Walking.
            spell = new EvadeSpellData("璧颁綅韬查伩", 1);
            Spells.Add(spell);
            ...
            {
                spell = new BlinkData("闂幇韬查伩", ObjectManager.Player.GetSpellSlot("SummonerFlash"), 400, 100, 5, true);
                Spells.Add(spell);
            }

            //Zhonyas
            spell = new EvadeSpellData("涓簹韬查伩", 5);
            Spells.Add(spell);
