...
namespace FuckingAwesomeLeeSin
{
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Base menu
            Menu = new Menu("FALeeSin浜岀嫍姹夊寲", ChampName, true);
            //Orbwalker and menu
            ...
            //InsecMenu
            var insecMenu = new Menu("Insec(闊╁浗鏈€寮虹洸鍍)", "Insec");
            ...
            SaveMeMenu.AddItem(new MenuItem("hpPercentSM", "WW鎯╂垝 on x%").SetValue(new Slider(10, 1)));
            SaveMeMenu.AddItem(new MenuItem("param1", "绂佹鎯╂垝-琛€閲忔帴杩憒 x%")); // TBC
            ...
            SaveMeMenu.AddItem(new MenuItem("dEpics", "锛堝彶璇楋紵锛墊").SetValue(true));// TBC
            ...
            wardjumpMenu.AddItem(new MenuItem("m2m", "浣跨敤榧犳爣绉诲姩e").SetValue(true));
            ...
            drawMenu.AddItem(new MenuItem("drawQ", "鑼冨洿 Q").SetValue(true));
            drawMenu.AddItem(new MenuItem("drawW", "鑼冨洿 W").SetValue(true));
            drawMenu.AddItem(new MenuItem("drawE", "鑼冨洿 E").SetValue(true));
            drawMenu.AddItem(new MenuItem("drawR", "鑼冨洿 R").SetValue(true));
            ...
            PrintMessage("鍔犺浇鎴愬姛!姹夊寲by浜岀嫍!QQ缇361630847");
        }
