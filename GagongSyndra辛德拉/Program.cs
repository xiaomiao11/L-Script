...
namespace GagongSyndra
{
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Base menu
            Menu = new Menu("Syndra浜岀嫍姹夊寲", "Syndra", true);
            ...
            Menu.SubMenu("Drawing").AddItem(new MenuItem("DrawQEC", "QE 鍏夋爣鎸囩ず").SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
            ...
            Game.PrintChat("Gagong Syndra 鍔犺浇鎴愬姛!姹夊寲by浜岀嫍!QQ缇361630847 !");
        }
