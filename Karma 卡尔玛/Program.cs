...
namespace Karma
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            _config = new Menu("Karma浜岀嫍姹夊寲", "Karma", true);
            ...
            _config.SubMenu("Combo").AddItem(new MenuItem("UseRCombo", "浣跨敤 R").SetValue(true));
            ...
            _config.SubMenu("Harass").AddItem(new MenuItem("UseWHarass", "浣跨敤 W").SetValue(false));
            _config.SubMenu("Harass").AddItem(new MenuItem("UseRHarass", "浣跨敤 R").SetValue(true));
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("UseEDefense", "浣跨敤E闃插崼").SetValue(true));
            ...
            _config.SubMenu("Drawings")
                .AddItem(new MenuItem("WRootRange", "W 鏍硅寖鍥磡").SetValue(new Circle(true, Color.MintCream)));
