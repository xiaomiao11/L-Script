...
namespace KatarinaKittyKill
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            menu = new Menu("Katarina浜岀嫍姹夊寲", "Katarina", true);
            ...
            //Key 
            menu.AddSubMenu(new Menu("閿綅", "Key"));
            menu.SubMenu("Key")
                .AddItem(
            ...
            menu.SubMenu("Key")
                .AddItem(
                    new MenuItem("lastHit", "琛ュ垁!").SetValue(
            ...
            menu.SubMenu("Combo").AddItem(new MenuItem("eDis", "鐢‥鑼冨洿").SetValue(new Slider(0, 0, 700)));
            menu.SubMenu("Combo").AddItem(new MenuItem("smartE", "R鏈塩d鏅鸿兘E ").SetValue(false));
            ...
            menu.SubMenu("Farm").AddItem(new MenuItem("UseQFarm", "浣跨敤Q娓呭叺").SetValue(false));
            menu.SubMenu("Farm").AddItem(new MenuItem("UseWFarm", "浣跨敤W娓呭叺").SetValue(false));
            menu.SubMenu("Farm").AddItem(new MenuItem("UseEFarm", "浣跨敤E娓呭叺").SetValue(false));
            menu.SubMenu("Farm").AddItem(new MenuItem("UseQHit", "浣跨敤Q琛ュ垁").SetValue(false));
            menu.SubMenu("Farm").AddItem(new MenuItem("UseWHit", "浣跨敤W琛ュ垁").SetValue(false));


            //killsteal
            menu.AddSubMenu(new Menu("鎶汉澶磡", "KillSteal"));
            menu.SubMenu("KillSteal").AddItem(new MenuItem("smartKS", "鏅鸿兘鍑绘潃").SetValue(true));
            menu.SubMenu("KillSteal").AddItem(new MenuItem("wardKs", "鐬溂鍑绘潃").SetValue(true));
            menu.SubMenu("KillSteal").AddItem(new MenuItem("rKS", "R鎶汉澶磡").SetValue(true));
            menu.SubMenu("KillSteal").AddItem(new MenuItem("rCancel", "娌℃湁R鎾ら攢鍑绘潃").SetValue(false));

            //Misc Menu:
            menu.AddSubMenu(new Menu("鏉傞」", "Misc"));
            menu.SubMenu("Misc").AddItem(new MenuItem("packet", "浣跨敤灏佸寘").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("dfg", "浣跨敤鍐ョ伀").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("ignite", "浣跨敤鐐圭噧").SetValue(true));
            menu.SubMenu("Misc")
                .AddItem(new MenuItem("igniteMode", "妯″紡").SetValue(new StringList(new[] {"杩炴嫑", "鎶汉澶磡"}, 0)));
            menu.SubMenu("Misc").AddItem(new MenuItem("autoWz", "鑷姩W鏁屼汉").SetValue(true));
