...
namespace KurisuRiven
{
    internal class KurisuRiven
    {
        ...
        private void Game_OnGameLoad(EventArgs args)
        {
            ...
            Game.PrintChat("KurisuRiven v0995 璇诲彇鎴愬姛锛侊紒锛亅 鍔犺浇鎴愬姛!姹夊寲by浜岀嫍!QQ缇361630847");
            config = new Menu("KurisuRiven 浜岀嫍姹夊寲", "kriven", true);
            ...
            // Draw settings
            Menu menuD = new Menu("鐩爣閫夋嫨: ", "dsettings");
            menuD.AddItem(new MenuItem("dsep1", "鐩爣閫夋嫨"));
            menuD.AddItem(new MenuItem("drawrr", "鏄剧ずR鑼冨洿")).SetValue(true);
            menuD.AddItem(new MenuItem("drawaa", "鏄剧ずAA鑼冨洿")).SetValue(true);
            menuD.AddItem(new MenuItem("drawp", "鏄剧ず鎶€鑳借鏃秥")).SetValue(true);
            menuD.AddItem(new MenuItem("drawengage", "鏄剧ず鐜╁紕鑼冨洿")).SetValue(true);
            menuD.AddItem(new MenuItem("drawjumps", "鏄剧ず璺崇偣")).SetValue(true);
            menuD.AddItem(new MenuItem("drawkill", "鏄剧ず鍑绘潃鎻愮ず")).SetValue(true);
            var dmgItem = new MenuItem("damageafter", "鏄剧ず缁勫悎杩炴嫑浼ゅ").SetValue(true);
            ...
            menuD.AddItem(new MenuItem("dsep2", "==== 璋冭瘯璁剧疆"));
            menuD.AddItem(new MenuItem("debugdmg", "璋冭瘯杩炴嫑浼ゅ")).SetValue(false);
            menuD.AddItem(new MenuItem("debugtrue", "鐪熸鐨勮皟璇曡寖鍥磡")).SetValue(false);
           
            config.AddSubMenu(menuD);

            Menu menuK = new Menu("閿綅閿佸畾:", "demkeys");
            menuK.AddItem(new MenuItem("combokey", "杩炴嫑鎸夐敭")).SetValue(new KeyBind(32, KeyBindType.Press));
            menuK.AddItem(new MenuItem("clearkey", "娓呯嚎鎸夐敭")).SetValue(new KeyBind(86, KeyBindType.Press));
            menuK.AddItem(new MenuItem("jumpkey", "璺冲鎸夐敭")).SetValue(new KeyBind(88, KeyBindType.Press));
            menuK.AddItem(new MenuItem("ksep1", "==== 璋冭瘯璁剧疆"));
            ...
            menuC.AddItem(new MenuItem("valorhealth", "琛€閲忕櫨鍒嗘瘮浣跨敤E")).SetValue(new Slider(40));
            ...
            menuC.AddItem(new MenuItem("bladewhen", "R浣跨敤鏃舵満 "))
                .SetValue(new StringList(new[] { "杞绘槗鏉€", "涓€鑸潃", "鍥伴毦鏉€" }, 2));
            menuC.AddItem(new MenuItem("checkover", "妫€娴嬫槸鍚﹀彲浠ュ嚮鏉€")).SetValue(false);
            menuC.AddItem(new MenuItem("wslash", "鍑绘潃鏄剧ず: "))
                .SetValue(new StringList(new[] { "鍙互鍑绘潃", "鏈€澶т激瀹硘" }, 1));
            menuC.AddItem(new MenuItem("csep3", "==== Q 璁剧疆"));
            menuC.AddItem(new MenuItem("blockanim", "灏佸寘Q(鍙栨秷鍚庢憞)")).SetValue(false);
            menuC.AddItem(new MenuItem("cancelanim", "Q 鍙栨秷绫诲瀷: "))
                .SetValue(new StringList(new[] { "绉诲姩", "绐佽繘", "寤惰繜" }));
            menuC.AddItem(new MenuItem("qqdelay", "Q 绐佽繘寤惰繜(姣): ")).SetValue(new Slider(1000, 0, 3000));
            config.AddSubMenu(menuC);

            // Extra Settings
            Menu menuO = new Menu("棰濆璁剧疆: ", "osettings");
            menuO.AddItem(new MenuItem("osep2", "==== 棰濆璁剧疆"));
            menuO.AddItem(new MenuItem("useignote", "浣跨敤鐐圭噧")).SetValue(true);
            menuO.AddItem(new MenuItem("useautow", "鑷姩 W")).SetValue(true);
            menuO.AddItem(new MenuItem("autow", "鑷姩 W浜烘暟")).SetValue(new Slider(3, 1, 5));
            menuO.AddItem(new MenuItem("osep1", "==== 鍏夐€熻繛鎷涜缃畖"));
            menuO.AddItem(new MenuItem("useautows", "鑷姩鍏夐€熻繛鎷泑")).SetValue(true);
            menuO.AddItem(new MenuItem("autows", "浣跨敤鍏夐€熻繛鎷涗激瀹硘%")).SetValue(new Slider(65, 1));
            menuO.AddItem(new MenuItem("autows2", "浣跨敤鍏夐€熻繛鎷涗汉鏁皘>=")).SetValue(new Slider(3, 2, 5));
            menuO.AddItem(new MenuItem("osep3", "==== 鎵撴柇璁剧疆"));
            menuO.AddItem(new MenuItem("interrupter", "鑷姩鎵撴柇")).SetValue(true);
            menuO.AddItem(new MenuItem("InterruptQ3", "I浣跨敤Q*3鎵撴柇")).SetValue(true);
            menuO.AddItem(new MenuItem("InterruptW", "浣跨敤W鎵撴柇")).SetValue(true);
            config.AddSubMenu(menuO);

            // Farm/Clear Settings
            Menu menuJ = new Menu("鎵撻噹/娓呭叺璁剧疆: ", "jsettings");
            ...
            menuJ.AddItem(new MenuItem("jsep2", "==== 娓呭叺璁剧疆"));
            ...
            // Advance Settings
            Menu menuA = new Menu("鎻愬崌璁剧疆: ", "asettings");
            menuA.AddItem(new MenuItem("asep1", "==== QA 璁剧疆"));
            menuA.AddItem(new MenuItem("autoconfig", "璁剧疆鎺ㄨ崘鍊紎")).SetValue(false);
            menuA.AddItem(new MenuItem("qcdelay", "鍙栨秷寤惰繜: ")).SetValue(new Slider(0, 0, 1200));
            menuA.AddItem(new MenuItem("aareset", "鑷姩澶嶄綅寤惰繜: ")).SetValue(new Slider(0, 0, 1200));
            menuA.AddItem(new MenuItem("asep4", "==== 娓告垙涓姝㈤」"));
            menuA.AddItem(new MenuItem("cursormode", "鍏夋爣璋冭瘯妯″紡")).SetValue(false);
            menuA.AddItem(new MenuItem("asep2", "==== 濡備綍鎹愯禒? :"));
