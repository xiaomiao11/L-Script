...
namespace Leesin
{
    internal static class LeeMethods
    {
        ...
        public static readonly List<String> JungleCamps = new List<string>(); //= { "Worm", "Dragon", "LizardElder", "AncientGolem" };
        public static readonly List<String> SmallMinionCamps =   new List<string>();// = { "Wraith", "Golem", "GreatWraith", "GiantWolf" };
        private static int _waitForSpell;
        ...
        public static void Smite()
        {
            ...
            foreach (var jungleMinion in
                jungleMinions.Where(
                    jungleMinion =>
                        JungleCamps.Any(j => jungleMinion.BaseSkinName == j) ||
                        SmallMinionCamps.Any(j => jungleMinion.BaseSkinName == j))
                    .Where(
                        jungleMinion =>
                            LeeUtility.MenuParamBool(jungleMinion.BaseSkinName) &&
                            jungleMinion.Health <=
