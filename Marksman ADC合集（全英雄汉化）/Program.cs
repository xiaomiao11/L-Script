...
namespace Marksman
{
    internal class Program
    {
        ...
        {
            Config = new Menu("Marksman浜岀嫍姹夊寲", "Marksman", true);
            CClass = new Champion();
            ...
            QuickSilverMenu.AddItem(new MenuItem("AnyTaunt", "瑙ｉ櫎鍢茶 ").SetValue(true));
            ...
            items.AddItem(
                new MenuItem("UseItemsMode", "鐗╁搧浣跨敤妯″紡").SetValue(
                    new StringList(new[] { "绂佺敤", "娣峰悎", "杩炴嫑", "閫氱敤" }, 2)));
            ...
            if (BaseType != CClass.GetType())
            {
                ...
                var harass = new Menu("杩炴嫑", "Harass");
                if (CClass.HarassMenu(harass))
                {
                    harass.AddItem(new MenuItem("HarassMana", "绂佺敤楠氭壈锛堟硶鍔涘€硷級").SetValue(new Slider(50, 100, 0)));
                ...
                var extras = new Menu("鍏跺畠", "Extras");
                ...
                var drawing = new Menu("鑼冨洿", "Drawings");
