...
namespace Orianna
{
    internal class Orianna
    {
        ...
        static Orianna()
        {
            ...
            //Create the menu
            Config = new Menu("Orianna#浜岀嫍姹夊寲", "Orianna", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRComboKillable", "浣跨敤R鍑绘潃").SetValue(true));
            Config.SubMenu("Combo")
                .AddItem(new MenuItem("UseRComboCount", "浣跨敤R浜烘暟").SetValue(new Slider(2, 1, 5)));
            ...
            Config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("HarassActiveT", "楠氭壈 (鑷姩)!").SetValue(
            ...
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("UseQFarm", "浣跨敤 Q").SetValue(
                        new StringList(new[] { "娣峰悎", "娓呭叺", "娣峰悎+娓呯嚎", "绂佺敤" }, 2)));
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("UseWFarm", "浣跨敤 W").SetValue(
                        new StringList(new[] { "娣峰悎", "娓呭叺", "娣峰悎+娓呯嚎", "绂佺敤" }, 1)));
            Config.SubMenu("Farm")
                .AddItem(
            ...
            Config.AddSubMenu(new Menu("鏉傞」", "Mixed"));
            Config.SubMenu("Mixed").AddItem(new MenuItem("UseRInterrupt", "浣跨敤R涓柇娉曟湳").SetValue(true));
