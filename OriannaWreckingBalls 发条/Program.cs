...
namespace OriannaWreckingBalls
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            menu = new Menu("Orianna浜岀嫍姹夊寲", "Orianna", true);
            ...
            //Keys
            menu.AddSubMenu(new Menu("閿綅", "Keys"));
            menu.SubMenu("Keys")
                .AddItem(
            ...
            menu.SubMenu("Keys")
                .AddItem(
                    new MenuItem("HarassActiveT", "楠氭壈 (鑷姩)!").SetValue(new KeyBind("Y".ToCharArray()[0],
                        KeyBindType.Toggle)));
            menu.SubMenu("Keys")
                .AddItem(
                    new MenuItem("LastHitQQ", "Q琛ュ垁").SetValue(new KeyBind("A".ToCharArray()[0],
                        KeyBindType.Press)));
            menu.SubMenu("Keys")
                .AddItem(
            ...
            //Q Menu
            menu.SubMenu("Spell").AddSubMenu(new Menu("Q璁剧疆", "QSpell"));
            menu.SubMenu("Spell").SubMenu("QSpell").AddItem(new MenuItem("qHit", "杩炴嫑Q浜烘暟").SetValue(new Slider(3, 1, 3)));
            menu.SubMenu("Spell").SubMenu("QSpell").AddItem(new MenuItem("qHit2", "娑堣€桻浜烘暟").SetValue(new Slider(3, 1, 4)));
            //W
            menu.SubMenu("Spell").AddSubMenu(new Menu("W璁剧疆", "WSpell"));
            menu.SubMenu("Spell").SubMenu("WSpell").AddItem(new MenuItem("autoW", "鑷姩W鏁屾柟").SetValue(new Slider(2, 1, 5)));
            //E
            menu.SubMenu("Spell").AddSubMenu(new Menu("E璁剧疆", "ESpell"));
            menu.SubMenu("Spell").SubMenu("ESpell").AddItem(new MenuItem("UseEDmg", "鑷姩E闃熷弸").SetValue(true));
            menu.SubMenu("Spell").SubMenu("ESpell").AddSubMenu(new Menu("鑷姩闃熷弸鎶ょ浘 ", "shield"));
            menu.SubMenu("Spell").SubMenu("ESpell").SubMenu("shield").AddItem(new MenuItem("eAllyIfHP", "濡傛灉HP<%").SetValue(new Slider(40, 0, 100)));
            ...
            //R
            menu.SubMenu("Spell").AddSubMenu(new Menu("R璁剧疆", "RSpell"));
            menu.SubMenu("Spell").SubMenu("RSpell").AddItem(new MenuItem("autoR", "鑷姩R浜烘暟").SetValue(new Slider(3, 1, 5)));
            menu.SubMenu("Spell").SubMenu("RSpell").AddItem(new MenuItem("blockR", "娌℃湁鏁屼汉绂佹R").SetValue(true));
            menu.SubMenu("Spell").SubMenu("RSpell").AddItem(new MenuItem("overK", "鍑绘潃妫€娴媩").SetValue(true));
            menu.SubMenu("Spell").SubMenu("RSpell").AddItem(
                    new MenuItem("killR", "鍗婅嚜鍔≧").SetValue(new KeyBind("T".ToCharArray()[0],
                        KeyBindType.Toggle)));

            //Combo menu:
            menu.AddSubMenu(new Menu("杩炴嫑", "Combo"));
            menu.SubMenu("Combo").AddItem(new MenuItem("selected", "鐩爣閫夋嫨").SetValue(true));
            ...
            menu.SubMenu("Combo").AddItem(new MenuItem("autoRCombo", "鑷姩 R").SetValue(new Slider(2, 1, 5)));
            ...
            //Farming menu:
            menu.AddSubMenu(new Menu("璧氶挶", "Farm"));
            ...
            menu.SubMenu("Farm").AddItem(new MenuItem("qFarm", "Q/W閲婃斁浜烘暟").SetValue(new Slider(3, 0, 5)));

            //intiator list:
            menu.AddSubMenu((new Menu("寮曠垎鍣▅", "Initiator")));
            ...
            menu.SubMenu("Misc").AddItem(new MenuItem("UseInt", "R涓柇娉曟湳").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("packet", "浣跨敤灏佸寘").SetValue(true));

            menu.SubMenu("Misc").AddSubMenu(new Menu("鑷姩R", "intR"));
            ...
            //Drawings menu:
            menu.AddSubMenu(new Menu("鑼冨洿", "Drawings"));
            ...
            Game.PrintChat(ChampionName + "--- by xSalice.鍔犺浇鎴愬姛!姹夊寲by浜岀嫍!QQ缇361630847");
        }
