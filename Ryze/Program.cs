...
namespace Ryze
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("Ryze-浜岀嫍姹夊寲", "Ryze", true);
            ...
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("UseWFarm", "浣跨敤 W").SetValue(
                        new StringList(new[] { "娣峰悎", "娓呯嚎", "娣峰悎+娓呯嚎", "涓嶆搷浣渱" }, 3)));
            Config.SubMenu("Farm")
                .AddItem(
            ...
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("FreezeActive", "娣峰悎!").SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("LaneClearActive", "娓呭叺!").SetValue(new KeyBind("V".ToCharArray()[0],
                        KeyBindType.Press)));
