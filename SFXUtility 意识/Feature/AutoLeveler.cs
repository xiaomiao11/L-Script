    ...
    internal class AutoLeveler : Base
    {
        ...
        private void OnGameLoad(EventArgs args)
        {
            try
            {
                ...
                var patternMenu = new Menu("鍔犵偣妯″紡", Name + "Pattern");
                patternMenu.AddItem(new MenuItem(Name + "PatternEarly", "浼樺厛绾").SetValue(new StringList(new[]
                {
                    "x 2 3 1",
                    "x 2 1",
                    "x 1 3",
                ...
                Menu.AddItem(new MenuItem(Name + "OnlyR", "浼樺厛 R").SetValue(false));
