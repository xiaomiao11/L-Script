        ...
        private void TrackersLoaded(object o)
        {
            try
            {
                if (o is Trackers && (o as Trackers).Menu != null)
                {
                    ...
                    var drawingMenu = new Menu("缁樺埗g", Name + "Drawing");
                    drawingMenu.AddItem(new MenuItem(Name + "DrawingCrossColor", "鍗佸瓧棰滆壊").SetValue(Color.DarkRed));
                    drawingMenu.AddItem(new MenuItem(Name + "DrawingLineColor", "绾块鑹瞸").SetValue(Color.White));

                    Menu.AddSubMenu(drawingMenu);

                    Menu.AddItem(new MenuItem(Name + "DrawAlly", "鐩熷弸").SetValue(false));
                    Menu.AddItem(new MenuItem(Name + "DrawEnemy", "鐩熷弸").SetValue(true));
                    Menu.AddItem(new MenuItem(Name + "Enabled", "鎵ц").SetValue(false));
