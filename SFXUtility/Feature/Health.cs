    ...
    internal class Health : Base
    {
        ...
        private void OnGameLoad(EventArgs args)
        {
            try
            {
                ...
                var inhibitorMenu = new Menu("姘存櫠濉攟", Name + "Inhibitor");
                inhibitorMenu.AddItem(new MenuItem(Name + "InhibitorColor", "棰滆壊").SetValue(Color.Yellow));
                inhibitorMenu.AddItem(new MenuItem(Name + "InhibitorEnabled", "鍚姩").SetValue(true));
                inhibitorMenu.AddItem(new MenuItem(Name + "InhibitorPercentage", "鐧惧垎姣攟").SetValue(true));

                var turretMenu = new Menu("鐐", Name + "Turret");
                turretMenu.AddItem(new MenuItem(Name + "TurretColor", "棰滆壊").SetValue(Color.Yellow));
                turretMenu.AddItem(new MenuItem(Name + "TurretEnabled", "鍚姩").SetValue(true));
                turretMenu.AddItem(new MenuItem(Name + "TurretPercentage", "鐧惧垎姣攟").SetValue(true));
