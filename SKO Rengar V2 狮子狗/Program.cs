...
namespace SKO_Rengar_V2
{
	class Program
	{
		...
		private static void Game_OnGameLoad(EventArgs args)
		{
			...
			SKOMenu = new Menu ("RengarV2浜岀嫍姹夊寲","SKORengar", true);

			var SKOTs = new Menu ("鐩爣閫夋嫨","TargetSelector");
			SimpleTs.AddToMenu(SKOTs);

			var OrbMenu = new Menu ("璧扮爫", "Orbwalker");
			...
			Combo.AddItem(new MenuItem ("HpAutoW", "鐢╓鏈€浣巪hp").SetValue(new Slider(20,1,100)));
			Combo.AddItem (new MenuItem("TripleQ", "涓夊€峾").SetValue(new KeyBind(OrbMenu.Item("Flee_Key").GetValue<KeyBind>().Key, KeyBindType.Press)));
			...
			Harass.AddItem(new MenuItem ("UseItemsHarass", "浣跨敤鐐圭噧").SetValue(true));
			...
			var JLClear = new Menu("娓呯嚎|娓呴噹", "JLClear");
			...
			var TROLLZINHONASRANKEDS = new Menu("鎶汉澶磡", "TristanaKillZiggs");
			...
			var CHUPARUNSCUEPA = new Menu("鑼冨洿", "Drawing");
			...
			Game.PrintChat("<font color='#07B88C'>SKO Rengar V2  鍔犺浇鎴愬姛!姹夊寲by浜岀嫍!QQ缇361630847!</font>");
