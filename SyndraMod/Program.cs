...
namespace Syndra
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("SyndraMod-浜岀嫍姹夊寲", "Syndra", true);
            ...
            Config.SubMenu("Misc").AddItem(new MenuItem("InterruptSpells", "QE涓柇娉曟湳").SetValue(true));
            Config.SubMenu("Misc").AddItem(new MenuItem("UseGap", "QE闃叉绐佽劯").SetValue(true));
