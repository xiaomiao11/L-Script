...
namespace Velkoz
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("Velkoz浜岀嫍姹夊寲", "Velkoz", true);
            ...
            Config.SubMenu("Combo")
                .AddItem(
                    new MenuItem("ComboActive", "鍚敤杩炴嫑!").SetValue(
            ...
            Config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("HarassActive", "鍚敤楠氭壈!").SetValue(
            ...
            Config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("LaneClearActive", "鍚敤娓呭叺!").SetValue(
