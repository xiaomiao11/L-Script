...
namespace Xerath
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("Xerath-浜岀嫍姹夊寲", "Xerath", true);
            ...
            Config.SubMenu("R").AddItem(new MenuItem("PingRKillable", "鍙嚮鏉€鑷姩R(浠呮湰鍦帮級").SetValue(true));
            Config.SubMenu("R").AddItem(new MenuItem("BlockMovement", "鍏抽棴鍙抽敭鐐瑰嚮鏀綬").SetValue(false));
            ...
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("RRangeM", "鍦ㄥ皬鍦板浘涓婃樉绀篟鑼冨洿").SetValue(new Circle(false,
